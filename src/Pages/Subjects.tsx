...
export default function Subjects() {
    ...
    <div className={"container"}>
                <h2 className={"text-center mt-5 text-success fw-bold text-decoration"}>ASIGNATURAS</h2>
                <div className={"info"}>
                        ...
                        {showModal &&
                            <Modal isOpen={showModal} toggle={() => handleShowModal()}>
                                <form onSubmit={handleSubmit}>
                                    <ModalHeader style={{backgroundColor: "#347094"}}>ASIGNATURAS</ModalHeader>
                                    <ModalBody style={{backgroundColor: "#4e86a9"}}>
                                        <label>
                                            NUMERO:<input className={"ms-3"} type={"text"} value={key}
                                        ...
                                        <br/><br/>
                                        <label>
                                            HORAS CLASE:<input className={"ms-3"} type={"number"} value={thours}
                                                                     onChange={handleThoursChange} required/>
                                        </label>
                                        <br/><br/>
                                        <label>
                                            HORAS PRACTICAS:<input className={"ms-3"} type={"number"} value={phours}
                                                                   onChange={handlePhoursChange} required/>
                                        </label>
                                        <br/><br/>
                                        <label>
                                            CREDITOS TOTALES:<input className={"ms-3"} type={"number"} value={credits}
                                ...
                                subject.map((item, index: number) => (
                                    <tr className={"align-middle"}>
                                        ...
                                        <td><Button color={"danger"}
                                                    onClick={() => deleteElement(item.key)}>ELIMINAR</Button></td>
                                    </tr>
                                ))
                            }
                            </tbody>
